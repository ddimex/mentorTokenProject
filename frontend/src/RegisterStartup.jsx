...
const RegisterStartup = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/registerMentor") {
      setPreview("./img/mentorDefault.png");
    } else {
      setPreview("./img/startupDefault.png");
    }
  }, [location.pathname]);
  ...
  const handleRegister = async (e) => {
    ...
    formDataWithFile.append("startupName", formData.startupName);
    ...
    try {
      const response = await fetch("http://localhost:10000/registerStartup", {
        method: "POST",
      ...
      <div className="formContainer">
        <div className="loginContainer flexCol">
          ...
          {count === 1 ? (
            ...
            <>
              <div className="loginText">
                <h1 className="loginTitle">Setup your startup</h1>
              </div>
